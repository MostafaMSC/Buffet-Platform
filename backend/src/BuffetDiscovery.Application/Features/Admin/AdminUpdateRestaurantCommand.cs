...
public record AdminUpdateRestaurantCommand(
    int Id,
    string Name,
    string NameAr,
    int AreaId,
...
public class AdminUpdateRestaurantCommandValidator : AbstractValidator<AdminUpdateRestaurantCommand>
{
    public AdminUpdateRestaurantCommandValidator()
    {
...
public class AdminUpdateRestaurantCommandHandler(
    IRestaurantRepository restaurants,
    IAreaRepository areas,
    IUnitOfWork unitOfWork) : IRequestHandler<AdminUpdateRestaurantCommand>
{
    public async Task Handle(AdminUpdateRestaurantCommand request, CancellationToken ct)
    {
