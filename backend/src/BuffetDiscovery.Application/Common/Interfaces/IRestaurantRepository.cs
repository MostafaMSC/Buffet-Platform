...
public interface IRestaurantRepository
{
    ...
    /// Includes Area and non-deleted Offerings with their Photos. Only Approved restaurants.
    Task<Restaurant?> GetApprovedWithOfferingsAsync(int id, CancellationToken ct);
